...
class MyInput
{
	...
	{
		xVal = yVal =0;
		DashButtonJustPressed = JumpButtonJustPressed = AttackButtonJustPressed = SpecialButtonPressed = InventoryButtonJustPressed = JumpButtonPressed = false;
	}
	...
	public static function update ()
	{
		...
		if (gp != null)
		{
			...
			JumpButtonPressed = gp.pressed.A;
